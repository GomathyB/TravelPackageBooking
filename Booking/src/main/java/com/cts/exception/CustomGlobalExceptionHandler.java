...
public class CustomGlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(UserNotFoundException exception,
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(PackageNotFoundException exception,
			WebRequest webRequest) {
	...
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(BookingIdNotFoundException exception,
			WebRequest webRequest) {
